...
import { BUDGET_CRITERION, CIRCLE_IMAGE_DIRECTORY, CIRCLE_PARTICIPATE_TABLE, METADATA_TABLE, PRIORITY_TABLE, REGISTERED_TABLE, WORK_IMAGE_DIRECTORY, WORK_TABLE } from './data/metadata';
import { getInfoAsync, makeDirectoryAsync } from 'expo-file-system';

export var db;

function executeDBUnit(query, onSuccess, onFail) {
